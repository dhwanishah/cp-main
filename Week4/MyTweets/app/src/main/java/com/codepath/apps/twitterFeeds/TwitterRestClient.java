package com.codepath.apps.twitterFeeds;
...
public class TwitterRestClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "ExNazJaMBzKjhXdqaJvGYiPR8";       // Change this
	public static final String REST_CONSUMER_SECRET = "vVLN93rVwbaOuJ815TBveHkQHruA80JvAlzNkFg6HbdO5J7Xsa"; // Change this
	public static final String REST_CALLBACK_URL = "oauth://twitterrestclient"; // Change this (here and in manifest)
	...
	public void getHomeTimelineMaxId(int count, long maxId, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", count);
